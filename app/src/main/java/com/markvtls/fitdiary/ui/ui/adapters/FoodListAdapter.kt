package com.markvtls.fitdiary.ui.ui.adapters
...
class FoodListAdapter(private val onItemClick: (FoodServing) -> Unit): ListAdapter<FoodServing, FoodListAdapter.FoodViewHolder>(DiffCallback) {
